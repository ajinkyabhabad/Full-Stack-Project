  ...
  <div class="row">
  		...
  		<c:forEach items="${events}" var="a" varStatus="count">   
            <div class="col-sm-3">
			    <div class="card">
			      <div class="card-body">
			      <form  action="/myapp/registeritem.htm" method="post">
			        <h4 class="card-title">${a.getEventname()}</h4>
			        <h6 class="card-title">Category : ${a.getLocation()}</h6>
			        <h6 class="card-title">Date: <fmt:formatDate value="${a.getEvent_date()}" pattern="yyyy-MM-dd" /></h6>
			        <p class="card-text">Item Name: ${a.getDetails()}</p>
			        <p class="card-text">Item Available: ${a.getSeats_available()}</p>
