...
<h3>Update Item</h3>
  <div class="jumbotron">
        ...
        <form action="/myapp/updateitemdetails.htm" method="post">
          <div class="form-group">
          
          	<div class="form-group">
             Rent ID: <input type="text" name="eventid" class="form-control" value="${event.getId()}" readonly="readonly" >
             </div>
          
          	<div class="form-group">
             Item Name      <input type="text" name="eventname" class="form-control" placeholder="Enter Event Name" value="${event.getEventname()}" >
             </div>
             
             
            <div class="form-group">
             Item Details:     <input type="text" name="details" class="form-control" placeholder="Specify the event details" value = "${event.getDetails()}"> 
             <small  class="form-text text-muted">Please enter more details about event</small>
            </div>
            
            <div class="form-group">
             Item Capacity:     <input type="number" name="capacity" class="form-control" placeholder="Capacity" value="${event.getCapacity()}"> 
            </div>
