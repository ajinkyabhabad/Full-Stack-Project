    ...
    <body>
        ...
        <div class="jumbotron">
          ...
          <p class="display-4">List Your Property for Events</p>
            ...
            <hr class="my-4">
            <p class="lead">
              <a class="btn btn-primary btn-lg" href="/myapp/ownercategories.htm" role="button">Explore</a>
            </p>
          ...
          <div class="col">
        	<div class="card" style="width: 30rem;">
			  ...
			  <div class="card-body">
			    ...
			    <a href="/myapp/addcategory.htm" class="btn btn-primary">Add</a>
			  </div>
			</div>
			</div>
			...
			<div class="card" style="width: 30rem;">
			  ...
			  <div class="card-body">
			    <h5 class="card-title">View Registered Category</h5>
			    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
			    <a href="/myapp/ownercategories.htm" class="btn btn-primary">View</a>
			  </div>
			</div>
			</div>
        	</div>
