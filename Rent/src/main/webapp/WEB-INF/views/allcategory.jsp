        ...
        <p><font color="red">${msg}</font></p>
         <table>
          <tr>
           ...
           <c:forEach items="${category}" var="a" varStatus="count">   
          <tr>
            <form  action="/myapp/updateCategory.htm" method="post">
            <td><input type="text"  name="categoryid" value ="${a.getId()}" readonly></td>                     
